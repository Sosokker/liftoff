...
function guessMuscleGroup(name) {
    ...
    if (lower.includes('bench') || lower.includes('chest') || lower.includes('fly') || lower.includes('pec deck') || lower.includes('butterfly') || lower.includes('push up') || lower.includes('push-up') || lower.includes('chest press') || lower.includes('incline press'))
        return 'Chest';
    if (lower.includes('squat') || lower.includes('leg press') || lower.includes('leg extension') || lower.includes('leg curl') || lower.includes('lunge') || lower.includes('calf') || lower.includes('hack squat') || lower.includes('goblet squat') || lower.includes('bulgarian'))
        return 'Legs';
    if (lower.includes('deadlift') || lower.includes('row') || lower.includes('pull up') || lower.includes('pull-up') || lower.includes('pulldown') || lower.includes('lat') || lower.includes('face pull') || lower.includes('t bar') || lower.includes('t-bar') || lower.includes('shrug'))
        return 'Back';
    if (lower.includes('press') || lower.includes('shoulder') || lower.includes('lateral raise') || lower.includes('front raise') || lower.includes('reverse fly') || lower.includes('arnold') || lower.includes('upright row'))
        return 'Shoulders';
    if (lower.includes('curl') || lower.includes('hammer'))
        return 'Biceps';
    if (lower.includes('pushdown') || lower.includes('extension') || lower.includes('skullcrusher') || lower.includes('skull crusher') || lower.includes('dip') || lower.includes('close grip'))
        return 'Triceps';
    if (lower.includes('crunch') || lower.includes('plank') || lower.includes('leg raise') || lower.includes('russian twist') || lower.includes('ab wheel') || lower.includes('woodchopper') || lower.includes('cable crunch') || lower.includes('hanging knee'))
        return 'Core';
    if (lower.includes('hip thrust') || lower.includes('glute') || lower.includes('kickback') || lower.includes('step up') || lower.includes('step-up') || lower.includes('swing'))
        return 'Glutes';
    if (lower.includes('run') || lower.includes('treadmill') || lower.includes('spin') || lower.includes('bike') || lower.includes('elliptical') || lower.includes('rowing machine') || lower.includes('cardio') || lower.includes('warm up') || lower.includes('warmup') || lower.includes('stretch'))
        return 'Cardio';
    return 'Other';
}
// Extract equipment from Hevy name suffix like "(Barbell)"
function extractEquipment(name) {
