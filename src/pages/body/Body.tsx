        ...
        <div class="grid grid-cols-2 gap-3">
          <Show when={latestMeasurement()?.weight}>
            <div class="stat-card p-3">
              ...
              <p class="text-[10px] text-neutral-500 dark:text-neutral-400">latest</p>
            </div>
          </Show>
        ...
        <Show when={activeTab() === 'weight'}>
          ...
          <div>
            ...
            <Show when={measurements().length > 0} fallback={
              <p class="text-sm text-neutral-500 dark:text-neutral-400">No measurements yet</p>
            }>
              <div class="space-y-2">
            ...
            <div class="card overflow-hidden">
              <div class="p-4 space-y-4">
                <For each={measurements().slice(0, 10)}>
                  {(m) => (
                    <div class="border-b border-neutral-100 dark:border-dark-border last:border-0 pb-4 last:pb-0">
                      <p class="text-xs font-medium text-neutral-500 dark:text-neutral-400 mb-2">
                        {m.date}
                      </p>
                      <div class="grid grid-cols-3 gap-2 text-sm">
                        <Show when={m.neck}>
                          <div class="bg-neutral-50 dark:bg-dark-surface rounded-lg p-2 text-center">
        ...
        <Show when={activeTab() === 'photos'}>
          ...
          <Show when={photos().length > 0} fallback={
            <div class="card p-8 text-center">
              <Camera class="w-12 h-12 text-neutral-300 dark:text-neutral-600 mx-auto mb-3" />
              <p class="text-neutral-500 dark:text-neutral-400 mb-2">No progress photos yet</p>
              <p class="text-sm text-neutral-400 dark:text-neutral-500">Take photos to track your visual progress</p>
            </div>
          }>
            <div class="grid grid-cols-2 gap-3">
              <For each={photos()}>
                {(photo) => (
                  <div class="card overflow-hidden">
                    ...
                    <Show when={!photo.photo_data}>
                      <div class="w-full aspect-square bg-neutral-100 dark:bg-dark-surface flex items-center justify-center">
                    ...
                    <div class="p-2">
                      ...
                      <Show when={photo.caption}>
                        <p class="text-[10px] text-neutral-500 dark:text-neutral-400 truncate">{photo.caption}</p>
                      </Show>
                      <button
        ...
        <div class="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" onClick={() => setShowAddModal(false)}>
          <div class="card w-full max-w-md p-6 max-h-[80vh] overflow-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={addMeasurement} class="space-y-3">
              ...
              <div class="pt-2">
                <p class="text-xs font-medium text-neutral-500 dark:text-neutral-400 mb-2">Body Measurements (cm/in)</p>
                <div class="grid grid-cols-2 gap-3">
                  {[
            ...
            <form onSubmit={uploadPhoto} class="space-y-3">
              ...
              <div>
                ...
                <Show when={photoPreview()} fallback={
                  <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-neutral-200 dark:border-dark-border rounded-xl cursor-pointer hover:border-primary transition-colors">
