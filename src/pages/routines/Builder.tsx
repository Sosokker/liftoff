      ...
      <Show when={!isLoading()}>
        ...
        <div class="space-y-3">
          <div class="flex items-center justify-between">
            ...
            <span class="text-sm text-neutral-500 dark:text-neutral-400">{exercises().length} total</span>
          </div>
            ...
            {(exercise, index) => (
              <div class="card p-4">
                ...
                <div class="grid grid-cols-3 gap-2">
                  <div>
                    <label class="text-xs text-neutral-500 dark:text-neutral-400 mb-1 block">Sets</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label class="text-xs text-neutral-500 dark:text-neutral-400 mb-1 block">Reps</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label class="text-xs text-neutral-500 dark:text-neutral-400 mb-1 block">Rest (s)</label>
                    <input
                      type="number"
