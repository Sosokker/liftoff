  ...
  return (
    <div class="flex flex-col items-center justify-center min-h-screen px-6">
      <div class="flex flex-col items-center mb-8">
        ...
        <p class="text-neutral-500 dark:text-neutral-400 mt-1">Log in to continue your fitness journey</p>
      </div>
      ...
      <p class="mt-6 text-sm text-neutral-500 dark:text-neutral-400">
        ...
        <button onClick={() => navigate('/register')} class="text-primary font-semibold">
          Sign up
        </button>
      </p>
    </div>
