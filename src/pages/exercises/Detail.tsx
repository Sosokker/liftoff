          ...
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-3 gap-3">
              <div class="stat-card p-3">
                ...
                <p class="text-[10px] text-neutral-400">kg/lbs</p>
              </div>
              <div class="stat-card p-3">
                <div class="flex items-center gap-1.5 mb-1">
                ...
                <p class="text-[10px] text-neutral-400">logged</p>
              </div>
              <div class="stat-card p-3">
                <div class="flex items-center gap-1.5 mb-1">
                ...
                <p class="text-[10px] text-neutral-400">records</p>
              </div>
            </div>
            ...
            <div>
              ...
              <Show when={history().length > 0} fallback={
                <p class="text-sm text-neutral-400">No history yet</p>
              }>
                <div class="space-y-2">
                  <For each={history()}>
                    {(h) => (
                      <div class="card p-3 flex items-center justify-between">
                        ...
                        <span class={`text-xs px-2 py-0.5 rounded-full ${
                          h.set_type === 'warmup' ? 'bg-yellow-900/30 text-yellow-400 bg-yellow-900/30' :
                          h.set_type === 'failure' ? 'bg-red-900/30 text-red-400 bg-red-900/30' :
                          'bg-[#262626] text-neutral-400 bg-[#1a1a1a]'
                        }`}>
                          {h.set_type}
                        </span>
                      </div>
